...
2. [7. UML Diagrams](#7-uml-diagrams)
   ...
   - [7.3 Activity Diagram](#73-ac  tivity-diagram)
...
- **Mermaid:** Renders in GitHub, GitLab, VS Code (with extension), and many Markdown viewers.  
- **PlantUML:** Use [plantuml.com](https://www.plantuml.com/plantuml) or VS Code PlantUML extension to generate images from the PlantUML snippets above.
