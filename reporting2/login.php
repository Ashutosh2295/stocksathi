...
<body>
    ...
    <script>
        ...
        function handleLogin(event) {
            ...
            // Simple validation - check if email matches registration
            if (registrationData.admin_email && email === registrationData.admin_email) {
                // Store login session
                sessionStorage.setItem('isLoggedIn', 'true');
                sessionStorage.setItem('userEmail', email);
                sessionStorage.setItem('userData', JSON.stringify({
                    email: email,
                    name: registrationData.admin_name || 'User',
                    organization: registrationData.org_name || 'Organization'
                }));
